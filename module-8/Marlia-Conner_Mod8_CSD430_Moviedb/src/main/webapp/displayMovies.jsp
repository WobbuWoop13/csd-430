...
<p>This table shows all movies currently stored. Each containing the following: ID, Title, Director, Genre, Year Released, and Rating.</p>
...
<p><a href="index.jsp">Return to Home</a> | <a href="addMovie.jsp">Add/Edit Movie</a></p>
